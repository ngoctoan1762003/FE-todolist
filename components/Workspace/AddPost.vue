<template>
    <div class=" relative bg-white p-10 rounded-md shadow-md flex flex-col gap-10 min-w-[400px]">
        <div class="text-lg text-gray-600 font-semibold">Thêm danh sách khác</div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios({
                method: 'post',
                url: `https://noneedtoaskthereasonswhy.onrender.com/api/v1/posts`,
                headers: {
                ...
                .catch((error) => {
                    ...
                    this.$notify({
                        title: 'Thất bại',
                        text: 'Không thể tạo thẻ, xin kiểm tra lại',
                        type: 'error',
                        group: 'foo',
                    })
                })
