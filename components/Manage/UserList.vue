    ...
    <div>
        ...
        <div class="user-list text-white font-medium p-5 w-full bg-[#262d34] rounded-[16px]">
            <div class="font-semibold user-list-row">
                ...
                <div class="user-list-row-cell birthday">Ngày tạo</div>
            ...
            <div v-for="user in users" class="user-list-row user-list-information" :key="user._id">
                ...
                <div class="user-list-row-cell first-name">{{ user.username }}</div>
                <div class="user-list-row-cell email">{{ user.email }}</div>
                <div class="user-list-row-cell birthday">{{ user.created_at.split('T')[0] }}</div>
...
export default {
    ...
    methods: {
        ...
        onDelete(id) {
            ...
            axios({
                method: 'delete',
                url: `https://noneedtoaskthereasonswhy.onrender.com/api/v1/users/${id}`,
                headers: {
