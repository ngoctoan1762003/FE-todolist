<template>
  <div class="default">
    ...
    <div class="px-5 flex gap-5">
      ...
      <UserList class="w-full" :users="users" @reload="reload" v-show="manageOption === 1 && !isLoading"
        />
...
export default {
  ...
  created() {
    ...
    if(JSON.parse(localStorage.getItem('user')).role !== 'admin') this.$router.push('/')
  },
  mounted() {
    const authorization = localStorage.getItem('accessToken')
    axios({
      method: 'get',
      url: `https://noneedtoaskthereasonswhy.onrender.com/api/v1/users`,
      headers: {
